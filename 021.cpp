...
int  main()
{
    ...
    cout << "--------มินิเกมฝึกตัวละคร---------"<< endl << "****โดย จำนวนรอบที่คุณใช้ในการเล่น มีผลต่อค่าพลัง ยิ่งใช้มากค่าพลังจะบวกน้อย ยิ่งใช้น้อยค่าพลังจะบวกมาก****"<< endl << "เลือกมินิเกม [1 = เกมเป่ายิงฉุบ | 2 = เกมทายเลช ] : " ;
    cin >> minigame ;
    if(minigame == 1 )
    {
